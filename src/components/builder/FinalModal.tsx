            ...
            <div className="flex gap-2">
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  placeholder="Ex: João"
                  className={`w-full rounded-lg border bg-card px-3 py-2.5 text-sm text-foreground placeholder:text-[#f9f9f9] focus:outline-none focus:ring-2 focus:ring-ring transition-colors ${
                ...
                <div className="flex gap-2">
                  ...
                  {country === "outro" && (
                    <input
                      ...
                      placeholder="+..."
                      className="w-16 rounded-lg border border-input bg-card px-2 py-2.5 text-sm text-foreground placeholder:text-[#f9f9f9] focus:outline-none focus:ring-2 focus:ring-ring flex-shrink-0"
                    />
                  )}
                  <input
                    type="tel"
                    ...
                    inputMode="numeric"
                    className={`flex-1 min-w-0 rounded-lg border bg-card px-3 py-2.5 text-sm text-foreground placeholder:text-[#f9f9f9] focus:outline-none focus:ring-2 focus:ring-ring transition-colors ${
